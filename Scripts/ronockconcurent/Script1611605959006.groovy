...
//WebUI.navigateToUrl('https://partnerwebtest.azurewebsites.net/Ads/CreateEditQuickAd?isFlyerAd=True\'')
//driver.get('https://partnerwebtest.azurewebsites.net/Ads/CreateEditQuickAd?isFlyerAd=True')

//driver.navigate().to('https://partnerwebtest.azurewebsites.net/Ads/CreateEditQuickAd?isFlyerAd=True\')

//driver.findElement(By.xpath("//*[text()='Create Quick Flyer']")).click();
